...
install.packages("<path to file>.tar.gz", type = "source", repos = NULL)
```
...
## Plotting
The PDF and CDF plots are generated for a model, or list of models, using the `tdPdfPlot()` and `tdPdfPlot()` functions. 
